/* Pranav Gogia and Dalton Firth
 * April 19 2016
 * Adventure Game Program
 * This is an adventure game and the users aim is to say where they want to go and kind the keys in the end to get out of the house
 */
...
public class AdventureAssignmentNew {
	...
	public static void main(String[] args) throws InterruptedException, LineUnavailableException, IOException, UnsupportedAudioFileException {
		...
		c.clear();
		// If the player wants to play then start loop
		...
		// if the player wants to play again then initiate loop again
