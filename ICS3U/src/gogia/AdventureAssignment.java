...
public class AdventureAssignment {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Image jpgTitlePage, jpgTitlePage1;

		jpgTitlePage = Toolkit.getDefaultToolkit().getImage("H:/git/ICS3U/ICS3U/resource/titlePage.jpg");
		Thread.sleep(10);
		c.clear();
		jpgTitlePage1 = Toolkit.getDefaultToolkit().getImage("H:/git/ICS3U/ICS3U/resource/titlePage1.jpg");
			...
			c.drawImage(jpgTitlePage1, 0, 85, 640,420, null);
			Thread.sleep(1000);
